<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="AGREGARAPARTAMENTO.aspx.vb" Inherits="WEBEMPRESARIAL.AGREGARAPARTAMENTO" %>
    ...
    <table class="auto-style5">
        ...
        <tr>
            <td class="auto-style24">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HOTEL %>" ProviderName="<%$ ConnectionStrings:HOTEL.ProviderName %>" SelectCommand="SELECT * FROM [apartamento] WHERE ([id_apartamento] = ?)" InsertCommand="INSERT INTO APARTAMENTO
VALUES
(@ID_APARTAMENTO,@NUMERO,@PISO,@PRECIO,@ESTADO,@TIPO_APARTAMENTO)">
                    <InsertParameters>
                        ...
                        <asp:ControlParameter ControlID="LTAPAR" Name="@TIPO_APARTAMENTO" PropertyName="SelectedValue" />
                    </InsertParameters>
                    <SelectParameters>
