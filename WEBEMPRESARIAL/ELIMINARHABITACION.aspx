<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="ELIMINARHABITACION.aspx.vb" Inherits="WEBEMPRESARIAL.ELIMINARHABITACION" %>
    ...
    <table class="auto-style5">
                            ...
                            <table class="auto-style23">
                                <tr>
                                    <td class="auto-style33" style="border-style: inherit">
                                        <asp:ImageButton ID="BTNELIMINAR" runat="server" Enabled="False" Height="90px" ImageUrl="~/IMG/ELIMINAR 3.png" Width="90px" />
                                    </td>
                                    <td class="auto-style33" style="border-style: inherit">
        ...
        <tr>
            <td class="auto-style24">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HOTEL %>" ProviderName="<%$ ConnectionStrings:HOTEL.ProviderName %>" SelectCommand="SELECT * FROM [habitacion] WHERE ([id_habitacion] = ?)" DeleteCommand="DELETE FROM HABITACION
