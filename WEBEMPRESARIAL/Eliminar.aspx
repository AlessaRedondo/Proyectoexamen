<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="Eliminar.aspx.vb" Inherits="WEBEMPRESARIAL.Eliminar" %>
    ...
    <table class="auto-style5">
        ...
        <tr>
            ...
            <td class="auto-style31">
                <table class="auto-style3" style="background-color: #CCCCCC; border-style: none; font-family: Arial; font-weight: bolder;">
                    <tr>
                            ...
                            <table class="auto-style23">
                                <tr>
                                    <td class="auto-style33" style="border-style: inherit">
                                        <asp:ImageButton ID="BTNELIMINAR" runat="server" Enabled="False" Height="67px" ImageUrl="~/IMG/ELIMINAR 3.png" Width="86px" />
                                    </td>
                                    <td class="auto-style33" style="border-style: inherit">
        ...
        <tr>
            <td class="auto-style24">
                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:HOTEL %>" DeleteCommand="DELETE FROM EMPLEADO
WHERE ID_EMPLEADO=@ID" ProviderName="<%$ ConnectionStrings:HOTEL.ProviderName %>" SelectCommand="SELECT * FROM [empleado] WHERE ([id_empleado] = ?)">
                    <DeleteParameters>
