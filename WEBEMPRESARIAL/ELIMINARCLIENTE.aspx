<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="ELIMINARCLIENTE.aspx.vb" Inherits="WEBEMPRESARIAL.ELIMINARCLIENTE" %>
    ...
    <table class="auto-style5">
        ...
        <tr>
            <td class="auto-style24">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HOTEL %>" ProviderName="<%$ ConnectionStrings:HOTEL.ProviderName %>" SelectCommand="SELECT * FROM [cliente] WHERE ([id_cliente] = ?)" DeleteCommand="DELETE FROM CLIENTE
WHERE ID_CLIENTE=@ID">
                    <DeleteParameters>
